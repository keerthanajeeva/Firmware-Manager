...
CREATE TABLE `customertype` (
  ...
  `CustomerType` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `IsActive` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `CustomerType_Unique` (`CustomerType`)
...
INSERT INTO `customertype` VALUES (20,'sri',1),(21,'sai',0),(22,'ram',1);
