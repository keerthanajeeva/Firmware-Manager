...
var Deviceinfo = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Deviceinfo, "TABLE_NAME", {
    ...
    Deviceinfo.getByID = function (_, _a) {
        var id = _a.id;
     ...
     */
    Deviceinfo.findMatching = function (_, fields) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Deviceinfo.createEntry = function (_, _a) {
     ...
     * Updates a device
     */
    Deviceinfo.updateEntry = function (_, _a) {
