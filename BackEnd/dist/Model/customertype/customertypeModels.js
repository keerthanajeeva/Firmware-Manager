...
var Customertype = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Customertype, "TABLE_NAME", {
    ...
    Customertype.getByID = function (_, _a) {
        var id = _a.id;
     ...
     */
    Customertype.findMatching = function (_, fields) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Customertype.createEntry = function (_, _a) {
     ...
     * Updates a device
     */
    Customertype.updateEntry = function (_, _a) {
