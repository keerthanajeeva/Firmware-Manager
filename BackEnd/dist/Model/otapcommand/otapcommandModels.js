...
exports.Otapcommand = void 0;
// const dbqueries=require('./db')
var dbqueries = require('../../config/dbqueries');
var mysqlwrapper = require('../../config/mysqlwrapper');
var Otapcommand = /** @class */ (function (_super) {
    __extends(Otapcommand, _super);
    function Otapcommand() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(Otapcommand, "TABLE_NAME", {
    ...
    Otapcommand.getByID = function (_, _a) {
        var DeviceID = _a.DeviceID;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.find(DeviceID)];
     ...
     */
    Otapcommand.findMatching = function (_, fields) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Otapcommand.createEntry = function (_, _a) {
        var PacketID = _a.PacketID, DeviceID = _a.DeviceID, Name = _a.Name, Message = _a.Message;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.insert(connection, {
                                data: {
                                    PacketID: PacketID, DeviceID: DeviceID, Name: Name, Message: Message
                                }
                            })];
                    case 3:
                        _result = _b.sent();
                        return [2 /*return*/, this.getByID(_, { DeviceID: _result.insertId })];
                    case 4:
     ...
     * Updates a device
     */
    Otapcommand.updateEntry = function (_, _a) {
...
exports.Otapcommand = Otapcommand;
